label vortex:
    ...
    if vortex_firsttime == 0:
        "Вы ожидали чего-то более... внушительного от места, называемого Омутом. Грандиозный водоворот или хотя бы воронка, изменяющая свой цвет вода, кровопролитные схватки с лезущими из глубин чертями - хоть что-нибудь, о чем без устали трепались подвыпившие мореходы. Но всё, что вы видите сами - буйки с флажками угрожающего фиолетового цвета, обозначающие границы омута, диковинное судно без палуб и парусов, качающееся на волнах, и скала странной округлой формы, поросшая чем-то неопрятным."
        ...
        menu:
            "Подойти к судну":
                ...
                " — Приятно познакомиться, господа. Меня зовут Джерри, я несу вахту около этой орясины. Очень рад вас видеть."
                "Вы расшаркиваетесь. Обросший (то есть Джерри, поспешно поправляетесь вы) с удовольствием разминается и приглашает вас задавать свои вопросы."
                menu:
                    "Судорожно ткнуть пальцем в глазастую скалу":
                        nvl clear
                        "Джерри разражается довольным хохотом - гораздо более довольным, чем можно было ожидать. Вы оглядываетесь по сторонам и видите, что по меньшей мере половина команды повторила ваше движение. Это действительно выглядит комично. Отдышавшись, Джерри извиняется ('никогда не могу удержаться, простите') и начинает рассказывать."
                        "Оказывается, скала с глазами - и не скала вовсе, а исполинский осьминог по имени Ворчальник, десятикратно превышающий в размерах любого обитающего в омуте. Его используют для транспортировки людей и груза вниз и вверх, а как именно - Джерри рассказывать отказывается: не хочет портить впечатление. Судя по хитрому выражению на его свободной от растительности части лица, это воистину интересный опыт."
                        menu: 
                            "Попросить доставить вас к старателям":
                                nvl clear
                                "Вы не уверены, что хотите узнавать, как именно нужно пользоваться осьминогом для транспортировки людей, но работа есть работа. Вы благодарите Джерри за рассказ и выясняете, может ли он доставить вас на станцию. Джерри почти извиняющимся тоном отвечает:"
                                ...
                                $ vortex_firsttime = 2
                                jump vortex_dive
                            "Попрощаться с Джерри и поплыть своей дорогой":
                                nvl clear
                    ...
                    "Держа себя в руках, осведомиться о глазастой скале":
                        nvl clear
                        "Вы усилием воли заставляете себя не кричать и размахивать руками, намекая таким образом моряку, что прямо за ним находится СКАЛА С ГЛАЗАМИ. Вместо этого вы вежливо спрашиваете, следует ли от каждого местного утеса ожидать таких грустных взглядов. Джерри довольно хохочет, а отдышавшись, поясняет:"
                        ...
                        "Вы не уверены, что хотите поближе знакомиться с осьминогом по имени Ворчальник, но виду не подаёте."
                        menu: 
                            "Попросить доставить вас к старателям":
                                nvl clear
                                "Работа есть работа, пусть она и связана с огромными осьминогами. Вы благодарите Джерри за рассказ и выясняете, может ли он доставить вас на станцию. Джерри почти извиняющимся тоном отвечает:"
                                " — Только если у вас есть груз из Адмиралтейства или заказанные станцией товары. Иначе никак: гонять Ворчальника впустую строго запрещено."
                                "Впрочем, вы отчетливо замечаете хитринку в глазах моряка. Возможно, моряки в этой части моря не очень стремятся выполнять все приказы начальства."
                                $ vortex_firsttime = 2
                                jump vortex_dive
                    ...
                    "Сделать вид, что глазастая скала вас не интересует и попросить доставить вас к старателям":
                        nvl clear
                        "Юнга раскрывает рот, чтобы задать волнующий всех (и вас тоже, откровенно говоря) вопрос, но на него шикают: мол, капитан не спросил, и тебе не след. Неожиданное, но приятное проявление субординации. Вы, откашлявшись, официальным тоном выясняете, может ли уважаемый Джерри доставить вас на станцию старателей. Джерри, кажется, удивлен отсутствием привычной реакции, но виду не подаёт и отвечает:"
                        ...
                        "Впрочем, вы отчетливо замечаете хитринку в глазах Джерри. Возможно, моряки в этой части моря не очень стремятся выполнять все приказы начальства."
                        $ vortex_firsttime = 2
                        jump vortex_dive
    ...
    if vortex_firsttime == 1:
        ...
        "Вы подплываете поближе и видите, что Джерри на этот раз сидит на башенке и курит, задумчиво разглядывая Ворчальника. Ворчальник равнодушно моргает, переводя взгляд с него на вас, и Джерри оборачивается и машет вам рукой."
        ...
        menu:
            "Попросить доставить вас к старателям":
                nvl clear
                "Вы сильны. Вы храбры. Отец хотел бы гордиться вами (и до сих пор хочет). Вы должны победить страх. Пройдя дорогой смертной тени, не убоитесь зла. Вы собираетесь с силами и деревянным голосом сообщаете, что вам необходимо попасть на станцию. Джерри почти извиняющимся тоном отвечает:"
                " — Только если у вас есть груз из Адмиралтейства или заказанные станцией товары. Иначе никак: гонять Ворчальника впустую строго запрещено."
                "Впрочем, вы отчетливо замечаете хитринку в глазах моряка. Возможно, моряки в этой части моря не очень стремятся выполнять все приказы начальства."
                $ vortex_firsttime = 2
                jump vortex_dive
    ...
    if vortex_firsttime == 2:
        ...
        menu:
            "Попроситься вниз, на станцию":
                nvl clear
                "Вы кратко сообщаете цель своего визита, и Джерри согласно кивает."
            ...
            "Развернуться и уплыть":
                " — Простите, уважаемый, мы не хотели вас тревожить. Юнга собрался покончить с собой и попытался утопиться, нечаянно задев в прыжке вашу субмарину. Сейчас мы его выудим и отправимся себе дальше, — поясняет ситуацию в кои-то веки выбравшийся на палубу кок, помогая промокшему насквозь юнге подняться на борт. Джерри озадаченно трясет бородой, но соглашается и, пожелав вам удачи, спускается обратно в субмарину."
                show screen map_screen
label vortex_dive:
    menu:
        ...
        "Сказать, что груз у вас есть":
            if "monetload" in gl_cargo:
                nvl clear
                " — Есть? Вот и славно, мы как раз ждем поставки! — радуется Джерри и добавляет:"
                " — Но придется его досмотреть. Не обессудьте, правила есть правила."
                "Вы отправляетесь в трюм; Джерри следует за вами. Спустившись в коридор перед трюмом, вы распахиваете перед Джерри дверь, давая ему возможность самому всё осмотреть. Джерри заглядывает внутрь, проверяет маркировки и объявляет, что, если его старые глаза не врут, поводов не пускать вас на станцию он не видит совершенно, и вы с парой матросов отправляетесь вместе с ним обратно к судну. Кое-как загрузившись на борт крохотной субмарины, вы пытаетесь устроиться поудобнее (безрезультатно) и заодно подсмотреть управление: мало ли, когда пригодится. Джерри дожидается, пока все найдут себе место, и затем командует погружение."
                menu:
                    "Погружаемся!":
                ...
                " — Есть? Вот и славно, мы как раз ждем поставки! — радуется Джерри и добавляет:"
                " — Но придется его досмотреть. Не обессудьте, правила есть правила."
                "Вы отправляетесь в трюм; Джерри следует за вами. Спустившись в коридор перед трюмом, вы распахиваете перед Джерри дверь, давая ему возможность самому всё осмотреть."
                ...
                menu:
                    "Извиниться, сославшись на дырявую память":
                        nvl clear
                        "Вы извиняетесь, сетуя на свою забывчивость. Джерри добродушно хлопает вас по плечу и советует есть побольше морепродуктов: они полезны для мозга. Довольно ироничный совет, но в лице моряка нет ни намёка на шутку."
                    ...
                    "Дать ему гаечным ключом по голове (конфликт)":
                        ...
                        nvl clear
                        " — Вы уверены, что... ЫК! — говорит Джерри, получив по затылку гаечным ключом, но, к сожалению, не падает оземь, а разворачивается и смотрит на вас уже не так дружелюбно, как раньше. Кажется, придётся драться."
                        ...
                        if ret[0] == u'F':
                            ...
                            "Даже ошарашенный и слегка потерявший ориентацию моряк - всё еще серьёзный противник. После непродолжительной, но яростной схватки Джерри наконец мягко сползает по стенке. Самое время подумать, для чего вы совершили нападение на вахтовика при исполнении."
                            ...
                            label vortex_gtfo:
                            menu:
                                "Уплыть отсюда, оставив Джерри":
                                    "Черт. Черт. Черт. Черт. Нужно замести следы и надеяться, что Джерри ничего не вспомнит. Нужно замести следы быстро и еще быстрее дать деру. Мама всегда говорила, что у вас проблемы с агрессией, и видит бог, она была права. Дождавшись, когда моряка перетащат в его бочку, вы на всех парусах уходите обратно в море."
                                    $ vortex_firsttime = -1
                                    show screen map_screen
                                "Уплыть отсюда, забрав Джерри с собой":
                                    ...
                                    $ vortex_firsttime = -2
                                    $ gl_cargo.append("jerry")
                                    show screen map_screen
                                "Захватить судно Джерри и попробовать попасть в Омут самостоятельно" if useless_variable == 0:
                                    $ useless_variable = 1
                                        ...
                                        menu: 
                                            ...
                                            "Постараться вспомнить, что вы знаете об Омуте и том, как он работает":
                                                ...
                                                if ret[0] == u'F':
                                                    ...
                                                    $ gl_cargo.append("jerry")
                                                    jump vortex_deep_dive
                                            "Привести Джерри в чувство и пытать его, пока он не расскажет всё сам" if useless_variable_2 == 0:
        ...
        "Решить проблему другим способом (конфликт)":
            ...
            if ret[0] == u'F':
                ...
                "Джерри с довольным видом прячет в карман звонко бренчащий мешочек и неизвестно зачем дважды бьёт себя пальцем по кончику носа. Изучать местные обычаи у вас сейчас нет желания, и вы с парой матросов отправляетесь следом за ним. Кое-как загрузившись на борт крохотной субмарины, вы пытаетесь устроиться поудобнее (безрезультатно) и заодно подсмотреть управление: мало ли, когда пригодится. Джерри дожидается, пока все найдут себе место, и затем командует погружение."
                menu:
                    "Погружаемся!":
                        jump vortex_deep_dive
            elif ret == u'SСила':
                "Даже не ожидающий нападения моряк - всё еще серьёзный противник. После непродолжительной, но яростной схватки Джерри наконец мягко сползает по стенке. Самое время подумать, для чего вы совершили нападение на вахтовика при исполнении."
                " — Капитан, для чего мы совершили бесчестное нападение на вахтовика при исполнении? — интересуется старпом. Вы не помните, чтобы назначали его своим внутренним голосом, но сейчас определенно есть вопросы поважнее. Например, что делать с телом или как же всё-таки попасть в Омут."
                jump vortex_gtfo
