                    ...
                    "В службы Адмиралтейства":
                        ...
                        menu:
                            ...
                            "Спросить помощи старпома":
                                ...
                                "Секретарь рад увидеть старпома значительно больше, чем вы могли предполагать. Немедленно начинаются расспросы и довольный хохот, на которые старпом отвечает довольно неохотно. Наконец, ему удается свернуть на нужную вам тему, и вопрос решается за пару секунд: секретарь, на мгновение взглянув в вашу сторону, нетерпеливо машет рукой, что вы истолковываете как приглашение войти, и разворачивается обратно к старпому."
                        ...
                        label start_your_first_contract:
                            ...
                            if start_firstofficer_helps == 1:
                                ...
                                " — Я, конечно, был рад помочь, но уходил из Адмиралтейства под ваше начало не для того, чтобы вновь с ними связываться. Я носил ливрею четырнадцать лет, в конце концов."
