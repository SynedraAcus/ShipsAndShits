...
label new_conflict:
    ...
    "Хотя вообще-то этот конфликт предназначен для того, чтобы тестировать поражение. По крайней мере, истраченные карты будут вам возвращены, чтоб не было совсем обидно."
