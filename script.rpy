    ...
    menu:
        "Начать сюжет":
            ...
            label start_after_shipboy:
                ...
                "Вся следующая неделя уходит на разнообразные корабельные заботы: вы ещё дважды бегали к отцу за деньгами, оплатили переоснастку и косметический ремонт кораблика, наняли кока и рулевого, обнаружили в трюме спящего боцмана, отнесшегося к новости о смене капитана безразлично, и по отцовой наводке приняли на борт немолодого мужчину в истертой форме Адмиралтейства, согласившегося быть старпомом. Юнга, действительно прибывший ровно через неделю, притащил с собой найденного в подворотне драного кошака и заявил, что его необходимо пустить на судно первым: на удачу. Юнгу неожиданно поддержал кок, рассказавший убедительную историю о том, как такая традиция распространена за океаном; разумеется, затем оба искали кошака по всем палубам и трюмам до тех пор, пока вы не смирились с мыслью, что теперь в экипаж входит корабельный кот, и не приказали заняться чем-нибудь полезным."
