...
init -5 python:
    ...
    #  Cities
    monet = Map_point('monet', (166, 638), random_events=False)
    tartari = Map_point('tartari', (287, 59), random_events=False)
    plains = Map_point('plains', (643, 66), random_events=False)
    vein = Map_point('vein', (146, 241), random_events=False)
    poop = Map_point('poop', (719, 315), random_events=False)
    office = Map_point('office', (1001, 363), random_events=False)
    yankee = Map_point('yankee', (401, 421), random_events=False)
    vortex = Map_point('vortex', (710, 507), random_events=False)
    monastery = Map_point('monastery', (653, 690), random_events=False)

    #  Nodes
    node1 = Map_point('node1', (149, 753))
    node2 = Map_point('node2', (324, 718))
    node3 = Map_point('node3', (230, 559))
    node4 = Map_point('node4', (433, 576))
    node5 = Map_point('node5', (695, 620))
    node6 = Map_point('node6', (902, 678))
    node7 = Map_point('node7', (580, 542))
    node8 = Map_point('node8', (901, 470))
    node9 = Map_point('node9', (295, 411))
    node10 = Map_point('node10', (614, 419))
    node11 = Map_point('node11', (800, 377))
    node12 = Map_point('node12', (114, 349))
    node13 = Map_point('node13', (429, 293))
    node14 = Map_point('node14', (540, 325))
    node15 = Map_point('node15', (951, 296))
    node16 = Map_point('node16', (161, 108))
    node17 = Map_point('node17', (360, 163))
    node18 = Map_point('node18', (505, 135))
    node19 = Map_point('node19', (720, 171))
    node20 = Map_point('node20', (890, 175))
